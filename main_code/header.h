...
void initCamera(VRmUsbCamDevice device, VRmDWORD& port1, VRmDWORD& port2, VRmDWORD& port3,VRmImageFormat& target_format, VRmDWORD screen_width, VRmDWORD screen_height, VRmColorFormat screen_format, VRmRectI& source_cropping_region);
